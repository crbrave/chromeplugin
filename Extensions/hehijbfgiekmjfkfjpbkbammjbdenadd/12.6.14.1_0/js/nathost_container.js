...
var NativeHostContainer = {
    ...
    onNativeMessage: function(msg, fnResponse) {
        ...
        switch(msg.type) {
            ...
            case 'FRAME_NAVIGATE_COMPLETE':
                ...
                break;
            case 'NEW_WINDOW':
                this.openNewWindow(msg.url, msg.features, { hostName: this.hostName, hostWindowId: msg.popupHostWindowId }, msg.forceChrome, msg.forceTab, msg.fromModal);
                break;
    ...
    finalInit: function() {
        ...
        window.addEventListener('keydown',function (e) {
            ...
            if ((e.keyCode == 114) || (e.ctrlKey && e.keyCode === 70)) {   // F3 or Ctrl+F
                e.preventDefault();
                this.sendNativeMessage({ type: 'SHOW_FIND' });
            } else if (e.ctrlKey && ((e.keyCode == 187) || (e.keyCode == 107))) {
                this.sendNativeMessage({ type: 'ZOOM', value: 1 });
                e.preventDefault();
            } else if (e.ctrlKey && ((e.keyCode == 189) || (e.keyCode == 109))) {
                this.sendNativeMessage({ type: 'ZOOM', value: -1 });
                e.preventDefault();
            } else if (e.ctrlKey && (e.keyCode == 48)) {
                e.preventDefault();
                this.sendNativeMessage({ type: 'ZOOM', value: 0 });
            }
        }.bind(this));

    ...
    run: function () {
        ...
        */
        ...
        test('Switching languages', function() {
            ...
            equal(background.getTableName(), 'php-offline-manual-sp', 'Database table name: ' + background.getTableName());

            background.setLocale('en');
            equal(background.getDatabaseLocale(), 'en', 'Database locale: ' + background.getDatabaseLocale());
            equal(background.getTableName(), 'php-offline-manual-en', 'Database table name: ' + background.getTableName());
        });

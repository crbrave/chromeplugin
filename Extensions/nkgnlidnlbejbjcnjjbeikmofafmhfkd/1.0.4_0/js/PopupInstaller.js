...
function PopupInstaller(callback) {
    ...
    this.install = function() {
        ...
        var $jokeElements = $('#install-jokes li');
        var randomItemsCount = $jokeElements.length;

        jokesInterval = setInterval(function(){
            var random = Math.floor(Math.random()*randomItemsCount);
            $jokeElements.hide(500);
            $jokeElements.eq(random).show(500);
        }, 8000);
